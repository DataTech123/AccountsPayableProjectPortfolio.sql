...
Design database explanation: 
While working with an ERP accounting system, it is unnessary to design a new database; it just needs to connect the ERP accounting system to SQL server ,such as Oracle database or IBM database, depending on each company's system configuration.
